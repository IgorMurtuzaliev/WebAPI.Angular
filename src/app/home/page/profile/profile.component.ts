...
export class ProfileComponent implements OnInit {
  ...
  constructor(private service: ProfileService, private router: Router, private toastr: ToastrService, private header: HeaderService) { }
  ngOnInit() {
...
// onHeaderEdit(nm: string){
// this.header.changeName(nm);
